...
// Temporary fix for KDE: KDE does only set one kbd_backlight brightness value, this version of the
...
static unsigned int convert_colour_to_hex(const char *colour_string)
{
